...
{
    /// <summary>
    /// Editor window for importing and reimporting models
    /// </summary>
    internal class ImportModel : EditorWindow
    {
        static Model model;
        ...
        /// <summary>
        /// Opens a dialog for finding a model file
        /// </summary>
        /// <remarks>
        /// Valid file types are LDraw, Stud.IO, LXFML and LXF
        /// </remarks>
        ...
        /// <param name="newReimportPath">An optional new path for the model</param>
        ...
        /// </summary>
        /// <param name="group">Group to reimport</param>
        ...
        private void OnGUI()
        {
            ...
            minSize = new Vector2(leftMargin + maxLabelWidth + 310, 226);
            maxSize = new Vector2(leftMargin + maxLabelWidth + 310, 2000);
            ...
            CreateHeaderUI(new Vector2(leftMargin + maxLabelWidth + 230.0f, 100.0f), "LOD", "LOD 0 includes chamfered edges.\nLOD 1 does not.\nLOD 2 simplifies knobs.");
            ...
            if (showAllBoolsUI)
            {
                ...
                CreateAllLODsUI(new Vector2(leftMargin + maxLabelWidth + 225.0f, nextY), importSettings);
            ...
            for (int i = 0; i < lxfml.groups.Length; i++)
            {
                ...
                if (showGroup)
                {
                    ...
                    CreateLODUI(new Vector2(leftMargin + maxLabelWidth + 225.0f, nextY), importSettings, i);
            ...
            else if (group)
            {
                ...
                if (importPressed)
                {
                    ...
                    var groupPos = group.transform.position;
                    var groupRotation = group.transform.rotation;

                    ModelImporter.ReimportModelGroup(lxfml, group, importSettings[group.number], true);

                    group.transform.position = groupPos;
                    group.transform.rotation = groupRotation;
            ...
            {
                EditorGUI.HelpBox(new Rect(leftMargin, nextY, maxLabelWidth + 290.0f, 38.0f), trackedError.Key, MessageType.Warning);
                // Reserve the space for the GUILayout scroll view.
                ...
                {
                    GUI.Label(new Rect(leftMargin, nextY, maxLabelWidth + 290.0f, 16.0f), id);
                    // Reserve the space for the GUILayout scroll view.
                    GUILayout.Space(20.0f);
                    nextY += 20.0f;
                }
