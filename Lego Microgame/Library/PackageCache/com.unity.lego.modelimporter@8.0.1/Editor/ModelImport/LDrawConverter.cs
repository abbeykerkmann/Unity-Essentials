...
{
    /// <summary>
    /// Provides methods for converting LDraw to LXFML
    /// </summary>
    internal static class LDrawConverter
    {
        private class Brick
        {
        ...
        /// <summary>
        /// Convert LDraw input to an LXFML document
        /// </summary>
        /// <param name="ldrawInput">The LDraw input</param>
        /// <param name="name">The name of the output model</param>
        /// <returns>Returns an LXFML as an xml document</returns>
        ...
        /// <summary>
        /// Get an error map for the conversion
        /// </summary>
        /// <returns>Returns a dictionary from error message to error ids</returns>
