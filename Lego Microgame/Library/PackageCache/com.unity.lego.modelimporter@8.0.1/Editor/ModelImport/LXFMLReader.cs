...
{
    /// <summary>
    /// Provides methods for reading LXFML files
    /// </summary>
    public class LXFMLReader
    {
        /// <summary>
        /// Creates an LXFML brick object from a brick node in an LXFML document
        /// </summary>
        /// <param name="brickNode">The xml brick node</param>
        /// <returns>Returns an <see cref="LXFMLDoc.Brick"/> object representing the brick node.</returns>
        ...
        /// <summary>
        /// Reads an LXFML document
        /// </summary>
        /// <param name="lxfmlDoc">The LXFML document</param>
        /// <param name="lxfml">The LXFMLDoc object that we populate</param>
        /// <returns>Returns <see langword="true"/> if the reading was successful, <see langword="false"/> otherwise.</returns>
