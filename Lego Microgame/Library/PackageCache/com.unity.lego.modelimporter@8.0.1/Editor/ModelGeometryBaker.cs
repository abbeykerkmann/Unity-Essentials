...
{
    internal static class ModelGeometryBaker
    {
        ...
        public static void BakeModelGeometry()
        {
            ...
            foreach (var part in parts)
            {
                ...
                if (decorationSurfaces)
                {
                    ...
                    {
                        if (decorationSurface.gameObject.activeInHierarchy)
                        {
                ...
                if (knobs)
                {
                    ...
                    {
                        if (knob.gameObject.activeInHierarchy)
                        {
                            BakeAndSetMesh(knob, knob.name, knob.GetComponent<MeshFilter>().sharedMesh);
                        }
                    }
                }
                ...
                if (tubes)
                {
                    ...
                    {
                        if (tube.gameObject.activeInHierarchy)
                        {
                            BakeAndSetMesh(tube, tube.name, tube.GetComponent<MeshFilter>().sharedMesh);
                        }
                    }
                }
            }
