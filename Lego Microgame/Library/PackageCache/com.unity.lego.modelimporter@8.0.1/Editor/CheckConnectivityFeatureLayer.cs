...
{
    internal class CheckConnectivityFeatureLayer
    {
        private static readonly string connectivityFeatureReceptorLayerAttempPrefsKey = "com.unity.lego.modelimporter.attemptCreatingMissingConnectivityFeatureReceptorLayer";
        private static readonly string connectivityFeatureConnectorLayerAttempPrefsKey = "com.unity.lego.modelimporter.attemptCreatingMissingConnectivityFeatureConnectorLayer";

        [InitializeOnLoadMethod]
        private static void DoCheckConnectivityFeatureLayer()
        {
