...
{
    /// <summary>
    /// Utility that provides functions for accessing and loading part related assets
    /// </summary>
    internal static class PartUtility
    {
        ...
        /// <summary>
        /// Unpack colliders for a part
        /// </summary>
        /// <param name="designID">The design ID of the part</param>
        /// <param name="forceUpdate">Whether or not to force unpacking</param>
        /// <returns>Returns <see langword="true"/> if the part was unpacked or already exists, <see langword="false"/> otherwise</returns>
        ...
        /// <summary>
        /// Load prefab for a colliders object given a design Id
        /// </summary>
        /// <param name="designID">The design Id</param>
        /// <returns>Returns the gameobject for the colliders prefab</returns>
