...
{
    /// <summary>
    /// Provides methods that relate to updating the hierachy as needed when auto update hierarchy is turned on.
    /// </summary>
    internal class ModelGroupUtility
    {
        /// <summary>
        /// Options for deciding undo behaviour on actions
        /// </summary>
        public enum UndoBehavior
        {
            /// <summary>
            /// Execute actions without undo
            /// </summary>
            withoutUndo,

            /// <summary>
            /// Execute actions with undo
            /// </summary>
            withUndo
        }
        ...
        /// <param name="undoBehavior">Whether or not to register undo for this action</param>
        /// <returns>Returns the new model group</returns>
        ...
        /// <param name="undoBehavior">Whether or not to register undo for this action</param>
        /// <returns>Returns <see langword="true"/> if the pivot was recomputed, <see langword="false"/> otherwise</returns>
        ...
        /// <summary>
        /// Recompute the pivot for a model according to the pivot type set on the model.
        /// </summary>
        /// <param name="model">The model to recompute the pivot for</param>
        /// <param name="alignRotation">Whether we also want to align rotation relative to the bricks in the model</param>
        /// <param name="undoBehavior">Whether or not to register undo for this action</param>
        /// <returns>Returns <see langword="true"/> if the pivot was recomputed, <see langword="false"/> otherwise</returns>
        ...
        /// <summary>
        /// Recompute the pivot for a model group.
        /// </summary>
        /// <remarks>
        /// The pivot type for a model group is always set to <see cref="Model.Pivot.BottomCenter"/>
        /// </remarks>
        /// <param name="group">The the model group to recompute the pivot for</param>
        /// <param name="alignRotation">Whether we also want to align rotation relative to the bricks in the group</param>
        /// <param name="undoBehavior">Whether or not to register undo for this action</param>
        /// <returns>Returns <see langword="true"/> if the pivot was recomputed, <see langword="false"/> otherwise</returns>
        ...
        /// <summary>
        /// Set the parent of a transform with or without undo
        /// </summary>
        /// <param name="transform">The transform that is getting a new parent</param>
        /// <param name="parent">The new parent</param>
        /// <param name="undoBehavior">Whether or not to record undo for this action</param>
        ...
        /// <summary>
        /// Destroy a gameobject with or without undo
        /// </summary>
        ...
        /// <summary>
        /// Destroy a collection of gameobject with or without undo
        /// </summary>
        /// <param name="gameObjects">The game objects to destroy</param>
        /// <param name="undoBehavior">Whether or not to record undo for this action</param>
                ...
                if (clustersForGroup.Count > 1)
                {
                    ...
                    foreach (var clusterInGroup in clustersForGroup)
                    {
                        ...
                        if(valid)
                        {
                            ...
                            newGroup.viewBasedOptimizations = group.viewBasedOptimizations;
