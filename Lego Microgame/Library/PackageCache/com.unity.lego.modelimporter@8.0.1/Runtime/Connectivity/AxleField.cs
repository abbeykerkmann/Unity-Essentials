...
{
    /// <summary>
    /// Represents a LEGO axle field.
    /// </summary>
    /// <remarks>
    /// Axle fields are both present in ordinary LEGO System and LEGO Technic.
    ...
    /// An axle field has only one axle feature, but an axle feature may be connected to many fields
    /// </remarks>
#if UNITY_EDITOR
    [ExecuteAlways]
#endif
    public class AxleField : ConnectionField
    {
        ...
        {
            /// <summary>
            /// The field this connection is connected to
            /// </summary>
            public AxleField field = null;

            /// <summary>
            /// The interaction between the owning field and this field
            /// </summary>
            public Connection.ConnectionInteraction interaction = Connection.ConnectionInteraction.Ignore;
        }

        /// <summary>
        /// Whether or not this field requires grabbing
        /// </summary>
        /// <remarks>
        /// Some axles require that the connecting feature is grabbing (such as clips)
        /// </remarks>
        public bool requireGrabbing;

        /// <summary>
        /// Whether or not this field is capped at the start
        /// </summary>
        public bool startCapped;

        /// <summary>
        /// Whether or not this field is capped at the end
        /// </summary>
        public bool endCapped;

        /// <summary>
        /// Whether or not this field is grabbing
        /// </summary>
        public bool grabbing;

        /// <summary>
        /// The length of this axle
        /// </summary>
        public float length;

        /// <summary>
        /// The feature this field represents
        /// </summary>
        public AxleFeature feature;

        /// <summary>
        /// A list of tuples representing connections
        /// </summary>
        ...
        /// <param name="pivot">The pivot to transform around</param>
        /// <param name="intersectionPoint">Where the two axles intersect</param>
        /// <param name="offset">Out parameter for the translation offset</param>
        /// <param name="angle">Out parameter for the angle required to rotate in place</param>
        /// <param name="axis">Out parameter for the axis requires to rotate around into place</param>
        ...
        /// <param name="sameDir">Whether or not the axles point in the same direction</param>
        /// <returns>Returns <see langword="true"/> if the rotation can be aligned, <see langword="false"/> otherwise</returns>
        ...
        internal void Disconnect(AxleFeature toDisconnect)
        {
