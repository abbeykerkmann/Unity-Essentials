...
{
    /// <summary>
    /// Represents a LEGO fixed field.
    /// </summary>
    /// <remarks>
    /// Fixed fields are fields that don't have any degrees of freedom on connection.
    ...
    public class FixedField : ConnectionField
    {
        ...
        /// <summary>
        /// The field this field is connected to
        /// </summary>
        /// <remarks>
        /// A fixed field can only be connected to one other field
        /// </remarks>
