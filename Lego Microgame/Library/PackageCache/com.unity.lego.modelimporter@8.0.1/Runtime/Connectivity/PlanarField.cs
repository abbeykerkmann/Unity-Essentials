...
{
    /// <summary>
    /// Represents a LEGO planar field.
    /// </summary>
    /// <remarks>
    /// Planar fields are the most basic and classic LEGO System connectivity types.
    /// If you imagine any classic LEGO brick with knobs on top and tubes at the bottom,
    /// those are planar fields.
    /// </remarks>
#if UNITY_EDITOR
    [ExecuteAlways]
#endif
    ...
    {
        /// <summary>
        /// Represents a connection between two fields
        /// </summary>
        [Serializable]
        public struct ConnectionTuple
        {
            /// <summary>
            /// The field that this tuple is connected to
            /// </summary>
            public PlanarField field;

            /// <summary>
            /// The index of the connection in the other field this is connected to
            /// </summary>
            ...
            /// </summary>
            /// <returns>Returns an empty tuple</returns>
            ...
            /// <summary>
            /// Check whether or not this tuple is an empty tuple
            /// </summary>
            /// <returns>Returns <see langword="true"/> if this tuple is empty, <see langword="false"/> otherwise.</returns>
            public bool IsEmpty()
            {
        ...
        /// <summary>
        /// The planar features owned by this field
        /// </summary>
        [HideInInspector] public PlanarFeature[] connections;

        /// <summary>
        /// List of indices representing features that are connected
        /// </summary>
        [HideInInspector] public List<int> connected = new List<int>();

        /// <summary>
        /// A count of how many features this field has that are connectable
        /// </summary>
        /// <remarks>
        /// Some features such as <see cref="PlanarFeature.PlanarConnectionType.voidFeature"/> are not connectable
        /// </remarks>
        [HideInInspector] public int connectableConnections;

        /// <summary>
        /// Array same size as amount of features that contain connection information
        /// </summary>
        [HideInInspector] public ConnectionTuple[] connectedTo;

        /// <summary>
        /// The size of the field grid
        /// </summary>
        ...
        /// <summary>
        /// Event that is raised when the field is destroyed
        /// </summary>
        public static event Action<ICollection<ConnectionField>> dirtied;
...
#region overrides
        ...
        /// <param name="f1Transform">The transform of the first field</param>
        /// <param name="f2Transform">The transform of the second field</param>
        ...
        /// <returns>Returns <see langword="true"/> if two fields overlap, <see langword="false"/> otherwise</returns>
        internal static bool GetOverlap(PlanarField f1, PlanarField f2, Matrix4x4 f1Transform, Matrix4x4 f2Transform, out Vector2Int min, out Vector2Int max)
        {
        ...
        /// </summary>
        /// <returns>Returns a list of indices of connected connections</returns>
        ...
        /// </summary>
        /// <returns>Returns <see langword="true"/> if the field has any available connections, <see langword="false"/> otherwise</returns>
        public bool HasAvailableConnections()
        {
            return connected.Count < connectableConnections;
        }    

        internal void OnConnect(PlanarFeature connection)
        {
            var index = connection.index;
            connected.Add(index);
        }

        internal void OnDisconnect(PlanarFeature connection)
        {
            var index = connection.index;
        ...
        /// <summary>
        /// Get the connection a connection is connected to
        /// </summary>
        /// <remarks>
        /// Assumes that there is a valid connection.
        /// </remarks>
        /// <param name="index">The index to the connection to check</param>
        /// <returns>Returns connection that the given connection is connected to</returns>
        ...
        /// <returns>Returns a <see cref="PlanarFeature"/> at a world position, <see langword="null"/> if none found</returns>
        ...
        /// <returns>Returns a <see cref="PlanarFeature"/> at a grid position, <see langword="null"/> if none found</returns>
        ...
        /// <returns>Returns the world position of <paramref name="connection"/></returns>
        ...
        /// Alignment requires that the two matrices are close enough to each other already in alignment.
        /// </remarks>
        ...
        /// <returns>Returns whether or not the transformation could be aligned</returns>
