...
namespace LEGOModelImporter
{
    ...
    internal class LEGOAsset : MonoBehaviour
    {
        ...
        private static List<LEGOAsset> legoAssets;
        ...
        /// <summary>
        /// Setup the LEGO asset with its required state
        /// </summary>
        ...
        /// <summary>
        /// Set the hide state of the LEGO asset in the hierarcy
        /// </summary>
        /// <remarks>
        /// In case <see cref="hideChildren"/> is set to true, this function also hides direct children.
        /// </remarks>
